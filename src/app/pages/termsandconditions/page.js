    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <h3>Contact Us</h3>
                <p>For any shipping-related inquiries, please reach out to us via our contact form.</p>
                ...
                <ul>
                    <li>✅ View, download, and print materials for personal use only.</li>
                </ul>

                <h4>🚫 You may NOT:</h4>
                <ul>
                    <li>Republish, sell, rent, or sub-license website materials.</li>
                    <li>Modify, redistribute, or exploit content for commercial use.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>❌ Send unsolicited marketing communications without consent.</li>
                </ul>

                <h3>User Content</h3>
                <p>By submitting content (text, images, videos, etc.), you grant MYZK.in a worldwide, irrevocable, non-exclusive, royalty-free license to use and distribute your content.</p>
                ...
                <p>MYZK.in is not liable for:</p>
                <ul>
                    <li>Direct or indirect financial losses from using this website.</li>
                    <li>Loss of data, profits, business relationships, or reputational harm.</li>
                </ul>

                <p><strong>Exceptions:</strong> These limitations do not apply in cases of:</p>
                <ul>
                    <li>Fraud or negligence by MYZK.in.</li>
                    <li>Unlawful exclusions or limitations under applicable law.</li>
                </ul>

                <h3>Indemnity</h3>
                <p>You agree to indemnify MYZK.in against any legal claims, losses, or damages resulting from a breach of these Terms.</p>

                <h3>Breach of Terms</h3>
                <p>If you violate these Terms, MYZK.in may:</p>
                <ul>
                    <li>🔹 Suspend or permanently ban your access to the website.</li>
                    <li>🔹 Block your IP address.</li>
                    <li>🔹 Take legal action.</li>
                </ul>

                <h3>Assignment of Rights</h3>
                <p>MYZK.in may transfer or subcontract its rights without notice. You cannot transfer your rights under these Terms.</p>
